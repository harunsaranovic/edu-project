...
CREATE TABLE `book` (
  ...
  `color` varchar(20) COLLATE utf8_swedish_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `book` VALUES (1,'Test Book Title','Test book desc','2020-10-19 14:05:34','blue');
...
-- Dump completed on 2020-10-19 14:18:54
