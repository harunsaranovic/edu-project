...
CREATE TABLE `teacher` (
  ...
  `password` varchar(300) COLLATE utf8_swedish_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `teacher` VALUES (1,'teacher','teacher'),(2,'admin','admin');
...
-- Dump completed on 2020-10-19 14:18:56
